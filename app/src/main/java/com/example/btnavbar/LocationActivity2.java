...
public class LocationActivity2 extends AppCompatActivity {
    ...
    public LocationRecyclerAdapter2 locationRecyclerAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        locationRecyclerAdapter = new LocationRecyclerAdapter2(this.getApplicationContext(),locationArrayList);
